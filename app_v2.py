...
if USE_AI:
    try:
        ...
        print("✅ AI 키워드 추천 모드 활성화 (GPT-4o-mini)")
    except ValueError as e:
        print(f"⚠️  AI 모드 활성화 실패: {e}")
        print("⚠️  기존 알고리즘으로 전환합니다.")
        recommender = KeywordRecommenderV2()
        USE_AI = False
else:
    recommender = KeywordRecommenderV2()
    print("✅ 기존 알고리즘 키워드 추천 모드")
...
if __name__ == '__main__':
    print("\n" + "="*80)
    print("🚀 업체 맞춤 키워드 추천 서비스 v2.0이 시작되었습니다!")
    print("="*80)
    print("\n✨ 새로운 기능:")
    print("   - 실제 네이버 플레이스 업체정보 형식 지원")
    print("   - 긴 소개글 자동 분석")
    print("   - 특별 강점 자동 감지 (야간진료, 주말진료, 전문분야 등)")
    print("   - 키워드 다중 선택 및 복사 기능")
    print("\n📱 웹 브라우저에서 접속하세요:")
    print("   http://localhost:5000")
    print("\n💡 API 엔드포인트:")
    print("   POST http://localhost:5000/api/recommend")
    print("   Body: {\"business_info\": \"업체 정보...\"}")
    print("\n" + "="*80 + "\n")
